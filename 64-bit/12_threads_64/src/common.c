...
// stops one character early and never writes the terminating NUL. That is why
// the tutorial's initrd.c contains lines like `dirent.name[3] = 0;` -- it is
// patching up after strcpy at every call site. It also forgets to return dest.
